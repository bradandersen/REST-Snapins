...
//---------------------------------
    {
        ...
        cols:[
			...
			{ view:"select",
				id: 'querytype',
				name: 'querytype',
				options: ['Name','IPv6','View','Zone','Comment'],
...
// Setup the AJAX query
    var params={
            ...
            '_return_fields%2B' : 'comment,disable,name,extattrs,ipv6addr,ttl,use_ttl,view,zone'
...
//console.log(params);
    webix.ajax().get( base_url + 'record:aaaa', params,
        // handlers
        {
