...
//            {id:"_ref", hidden: true, header:"ref", adjust:"data" },
            {id:"network_view", header:["Network View",{content:"selectFilter"}], adjust:"data", sort:"string"},
            {id:"network", header:["Network",{content:"textFilter"}], adjust:"data", sort:"string"},
            {id:"network_container", header:["Container",{content:"textFilter"}], adjust:"data", sort:"string"},
            {id:"netmask", header:["Netmask",{content:"textFilter"}], adjust:"data", sort:"string"},
            {id:"template", header:["Template",{content:"textFilter"}], adjust:"data", sort:"string"},
...
//            '_return_fields%2B' : 'authority,disable,enable_ddns,extattrs,ipv4addr,netmask,network_container,options,unmanaged,ddns_domainname,ddns_use_option81'
    ...
    var queryobj="network";
    if(querytype=="IPv4"){var queryobj="ipv4addr";}
    if(querytype=="Comment"){var queryobj="comment";queryop="~:";}
    if(querytype=="Container"){var queryobj="network_container";queryop="";}
    if(querytype=="View"){var queryobj="network_view";queryop="";}
...
//console.log(params);
    webix.ajax().get( base_url + 'network', params,
        // handlers
        {
