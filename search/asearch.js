...
//---------------------------------
    {
        ...
        cols:[
			...
			{ view:"select",
				id: 'querytype',
				name: 'querytype',
				options: ['Name','IPv4','View','Zone','Comment'],
...
//Have a hard time sorting and filtering on boolean values, even if I convert them .toString(), so just make it sortable
            ...
            {id:"dns_name", header:["DNS Name",{content:"textFilter"}], adjust:"data", sort:"string"},
...
// Setup the AJAX query
    var params={
            ...
            '_return_fields%2B' : 'comment,disable,dns_name,extattrs,ipv4addr,name,ttl,use_ttl,view,zone'
...
//console.log(params);
    webix.ajax().get( base_url + 'record:a', params,
        // handlers
        {
