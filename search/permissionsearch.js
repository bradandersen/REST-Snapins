...
//---------------------------------
    {
        ...
        cols:[
			...
			{ view:"select",
				id: 'querytype',
				name: 'querytype',
				options: ['Group','Object','Permission','Resource Type','Role'],
...
//            {id:"_ref", hidden: true, header:"ref", adjust:"data" },
            {id:"group", header:["Group",{content:"selectFilter"}], adjust:"data", sort:"string"},
            {id:"role", header:["Role",{content:"selectFilter"}], adjust:"data", sort:"string"},
            {id:"resource_type", header:["Resource Type",{content:"selectFilter"}], adjust:"data", sort:"string"},
            {id:"permission", header:["Permission",{content:"selectFilter"}], adjust:"data", sort:"string"},
            {id:"object", header:["Object",{content:"textFilter"}], adjust:"data", sort:"string"},
...
// Setup the AJAX query
    var params={
            ...
            '_return_fields%2B' : 'group,object,permission,resource_type,role'
//            '_return_fields%2B' : 'authority,disable,enable_ddns,extattrs,ipv4addr,netmask,network_container,options,unmanaged,ddns_domainname,ddns_use_option81'
    ...
    //group,object,permission,resource_type,role
    var queryobj="group";
    if(querytype=="Object"){var queryobj="object";}
    if(querytype=="Permission"){var queryobj="permission";}
    if(querytype=="Resource Type"){var queryobj="resource_type";}
    if(querytype=="Role"){var queryobj="role";}
...
//console.log(params);
    webix.ajax().get( base_url + 'permission', params,
        // handlers
        {
