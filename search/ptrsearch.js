...
//---------------------------------
    {
        ...
        cols:[
			...
			{ view:"select",
				id: 'querytype',
				name: 'querytype',
				options: ['PTR','IPv4','IPv6','View','Zone','Comment'],
...
//            {id:"_ref", hidden: true, header:"ref", adjust:"data" },
            ...
            {id:"ptrdname", header:["PTR",{content:"textFilter"}], adjust:"data", sort:"string"},
            {id:"ipv4addr", header:["IPv4 Address",{content:"textFilter"}], adjust:"data", sort:"string"},
            {id:"ipv6addr", header:["IPv6 Address",{content:"textFilter"}], adjust:"data", sort:"string"},
...
// Setup the AJAX query
    var params={
            ...
            '_return_fields%2B' : 'comment,disable,ptrdname,extattrs,ipv4addr,ipv6addr,ttl,use_ttl,view,zone'
...
//console.log(params);
    webix.ajax().get( base_url + 'record:ptr', params,
        // handlers
        {
